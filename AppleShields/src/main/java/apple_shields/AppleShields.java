...
public class AppleShields
{
    ...
    public static void createShieldTypes()
    {
        ...
        if (IS_RF_PRESENT)
        {
            ITEM_SHIELD_RF_WHITE_APPLE.setShieldType(new ShieldTypeEnergy(new ItemStack(ITEM_FOOD_WHITE_APPLE), new ItemStack(Blocks.REDSTONE_BLOCK), SOUND_APPLE_CRUNCH, SOUND_APPLE_SPLAT, ConfigHandler.SHIELD_DURABILITY_RF_WHITE_APPLE));
        }
    }
